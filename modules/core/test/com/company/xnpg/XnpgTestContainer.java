...
public class XnpgTestContainer extends TestContainer {

    public XnpgTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/xnpg/app.properties",
    ...
    public static class Common extends XnpgTestContainer {

        public static final XnpgTestContainer.Common INSTANCE = new XnpgTestContainer.Common();
